...
node --check evidence/v0.12.23/computer/helper-evidence-rig.mjs
node evidence/v0.12.23/computer/helper-evidence-rig.mjs --self-test
...
xcrun swiftc -typecheck evidence/v0.12.23/computer/HelperEvidenceFixture.swift
xcrun swiftc -typecheck evidence/v0.12.23/computer/SystemProbe.swift
xcrun swiftc -typecheck evidence/v0.12.23/computer/AppShareHandoff.swift
app_share_handoff_self_test="$validation_stage/lbb-app-share-handoff-self-test"
xcrun swiftc evidence/v0.12.23/computer/AppShareHandoff.swift -o "$app_share_handoff_self_test"
