...
node --check evidence/v0.12.43/computer/helper-evidence-rig.mjs
node evidence/v0.12.43/computer/helper-evidence-rig.mjs --self-test
...
xcrun swiftc -typecheck evidence/v0.12.43/computer/HelperEvidenceFixture.swift
xcrun swiftc -typecheck evidence/v0.12.43/computer/SystemProbe.swift
