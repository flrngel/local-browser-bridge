...
node --check evidence/v0.12.18/computer/helper-evidence-rig.mjs
node evidence/v0.12.18/computer/helper-evidence-rig.mjs --self-test
...
xcrun swiftc -typecheck evidence/v0.12.18/computer/HelperEvidenceFixture.swift
xcrun swiftc -typecheck evidence/v0.12.18/computer/SystemProbe.swift
xcrun swiftc -typecheck evidence/v0.12.18/computer/PointerHandoff.swift
pointer_handoff_self_test="$validation_stage/lbb-pointer-handoff-self-test"
xcrun swiftc evidence/v0.12.18/computer/PointerHandoff.swift -o "$pointer_handoff_self_test"
