...
'@
        ...
        $inputServer = [IO.Path]::Combine($selfTestInputs, "local-browser-bridge-v0.12.45-windows-x86_64.exe")
        $inputHelper = [IO.Path]::Combine($selfTestInputs, "local-computer-helper-v0.12.45-windows-x86_64.exe")
