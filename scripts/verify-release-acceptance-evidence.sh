...
PY
  jq -e '
      ...
      and .version == "0.12.43" and .target == "loopback-demo" and .passed == true
  ...
  jq -e '
      ...
      and .version == "0.12.43" and .passed == true
  ...
  jq -e '
      ...
      and .extension.cardCount == 1 and .extension.version == "0.12.43" and .extension.enabled == true
