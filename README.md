...
> Version 0.12.3 is the current source and release target. Release artifacts, evidence, and capability claims are versioned; install the server, extension, and helper from one matching release.
