...
The v0.12.23 release harness uses a create-once request/start/complete chain around one acceptance-only app-share button action. That chain is orchestration evidence, not a notification-only signal and not authority to control the product target.
