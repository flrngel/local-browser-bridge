...
>
> Version 0.12.40 retains the Job topology but resolves only the prospective
...
> Version 0.12.40 requires entirely fresh candidate and acceptance evidence. Do
...
- no 0.12.40 tag has been created or pushed;
- no packaged 0.12.40 server, helper, or extension has been built, downloaded,
  or executed;
...
The active 0.12.40 source provides a checked-in
