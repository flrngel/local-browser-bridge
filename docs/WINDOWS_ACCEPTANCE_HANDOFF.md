...
> Version 0.12.58 requires entirely fresh candidate and acceptance evidence. Do
...
- no 0.12.58 tag has been created or pushed;
- no packaged 0.12.58 server, helper, or extension has been built, downloaded,
  or executed;
...
The active 0.12.58 source provides a checked-in
