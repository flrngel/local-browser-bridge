...
> Version 0.12.55 requires entirely fresh candidate and acceptance evidence. Do
...
- no 0.12.55 tag has been created or pushed;
- no packaged 0.12.55 server, helper, or extension has been built, downloaded,
  or executed;
...
The active 0.12.55 source provides a checked-in
