...
Protocol version: `1`. Package version examples below use `0.12.68`.

Agents that support the open Agent Skills format can install the compact
[`local-browser-bridge` skill](https://github.com/flrngel/local-browser-bridge/blob/main/skills/local-browser-bridge/SKILL.md). Its
