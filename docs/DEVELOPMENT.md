...
exact v0.12.33/schema-2 marker field set and order, a fresh non-expired publication,
...
For v0.12.33, the canonical evidence branch is
`evidence/v0.12.33-release-run-RUN_ID-attempt-RUN_ATTEMPT`, and its additions
live below
`evidence/v0.12.33/release/run-RUN_ID-attempt-RUN_ATTEMPT/`. The five primary
machine records are:
