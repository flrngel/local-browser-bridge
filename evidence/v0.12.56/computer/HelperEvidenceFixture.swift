...
private let fixtureTitle = "LBB v0.12.56 Persistent SCStream Evidence"
...
private final class FixtureView: NSView, NSTextFieldDelegate {
    ...
    override func updateTrackingAreas() {
        ...
        movementTrackingArea = trackingArea
    }
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        "Local Browser Bridge — v0.12.56 persistent SCStream".draw(
