# Windows v0.12.13 stock-Chrome acceptance

This directory defines the release gate for the v0.12.13 browser extension and
...
or generated evidence byte may be reused for v0.12.13. A failed or interrupted
...
```powershell
$trustDestination = Join-Path ([IO.Path]::GetTempPath()) ("lbb-1213-" + [Guid]::NewGuid().ToString("N"))
...
From the exact clean v0.12.13 checkout, invoke:
