...
const EXPECTED_VERSION = "0.12.18";
...
const FIXTURE_TITLE = "LBB v0.12.18 Persistent SCStream Evidence";
const SIBLING_FIXTURE_TITLE = "LBB v0.12.18 Same-PID Sibling Receiver";
const SEMANTIC_VALUE = "v0.12.18-semantic-value";
...
async function main() {
  ...
  scratchDir = await mkdtemp(join(scratchParent, "lbb-v0.12.18-scstream-"));
  ...
  const result = {
    ...
    candidateNotice: "This becomes release evidence only after the supplied checksum manifest and archive are published immutably for v0.12.18.",
    ...
    limitations: [
      "This run proves the supplied v0.12.18 macOS release-candidate archive, not an immutable GitHub release until those exact checksums are published.",
...
if (preparePackageMode) {
  ...
  try {
    ...
    if (scratchDir?.startsWith(`${scratchParent}/lbb-v0.12.18-scstream-`)) {
