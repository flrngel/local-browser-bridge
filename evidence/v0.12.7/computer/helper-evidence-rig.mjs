...
const FIXTURE_TITLE = "LBB v0.12.7 Persistent SCStream Evidence";
const SIBLING_FIXTURE_TITLE = "LBB v0.12.7 Same-PID Sibling Receiver";
const SEMANTIC_VALUE = "v0.12.7-semantic-value";
...
async function main() {
  ...
  scratchDir = await mkdtemp(join(scratchParent, "lbb-v0.12.7-scstream-"));
  ...
  const result = {
    ...
    candidateNotice: "This becomes release evidence only after the supplied checksum manifest and archive are published immutably for v0.12.7.",
    environment: {
    ...
    limitations: [
      "This run proves the supplied v0.12.7 macOS release-candidate archive, not an immutable GitHub release until those exact checksums are published.",
...
try {
  ...
  if (scratchDir?.startsWith(`${scratchParent}/lbb-v0.12.7-scstream-`)) {
